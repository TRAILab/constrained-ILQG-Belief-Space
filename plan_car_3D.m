...
% a pan-tilt gimbal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plan_car_3D(mapPath, trainPath, outDatPath)
...
mm = car_panTilt(dt); % motion model

om = pantilt_stereoCamModel(1:length(map.landmarks(1,:)),map.landmarks); % observation model
