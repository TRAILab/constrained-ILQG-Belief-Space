function b_next = beliefDynamicsFIF(b, u, motionModel, obsModel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Propagate beliefs using FIF to retrieve measurement information 
...
%   obsModel: Observation model loaded with FIF matrix
%
% Outputs:
