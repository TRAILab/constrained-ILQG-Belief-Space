function [g,c,gb,gu,gbb,gbu,guu,cb,cu,cbb,cbu,cuu] = beliefDynCost_nonsmooth(b,u,xf,L,full_DDP,motionModel,obsModel, collisionChecker, map)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if nargout == 2
    g = beliefDynamics_nonsmooth(b, u, motionModel, obsModel);
    ...
    xu_dyn  = @(xu) beliefDynamics_nonsmooth(xu(ib,:),xu(iu,:),motionModel, obsModel);
